    ...
    <div className="min-h-screen bg-linear-to-br from-gray-900 to-black text-white p-4">
      <div className="max-w-4xl mx-auto">
        <header className="text-center mb-8 pt-8">
          <h1 className="text-4xl font-bold mb-2 bg-linear-to-r from-purple-500 to-pink-500 bg-clip-text text-transparent">
            Movie Recommendations
          </h1>
          <p className="text-gray-400">
            Discover and compare your favorite movies
          </p>
        </header>
        ...
        <main className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 shadow-2xl border border-gray-700">
          ...
          <div className="mt-8">
            {selectedOption && <FormOption {...selectedOption} />}
          </div>
        </main>
      </div>
    </div>
