...
export default function CompareResults ({
    ...
    return (
        <div className="mt-8 animate-fadeIn">
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-orange-900/20 to-red-900/20 border border-orange-700/30 p-6 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="group relative overflow-hidden rounded-2xl border border-orange-800/30 bg-gradient-to-br from-gray-900 to-gray-950 p-6 transition-all hover:border-orange-500/50 hover:shadow-xl hover:shadow-orange-900/20">
                    ...
                    <div className="relative z-10">
                        <div className="flex items-center justify-between mb-4">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <div className="text-xs text-gray-400 uppercase tracking-wider">Película 1</div>
                                    <h5 className="text-lg font-bold text-orange-300">{firstMovie}</h5>
                                </div>
                            </div>
                ...
                <div className="group relative overflow-hidden rounded-2xl border border-red-800/30 bg-gradient-to-br from-gray-900 to-gray-950 p-6 transition-all hover:border-red-500/50 hover:shadow-xl hover:shadow-red-900/20">
                    ...
                    <div className="relative z-10">
                        <div className="flex items-center justify-between mb-4">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <div className="text-xs text-gray-400 uppercase tracking-wider">Película 2</div>
                                    <h5 className="text-lg font-bold text-red-300">{secondMovie}</h5>
                                </div>
                            </div>
                            <div className="text-4xl opacity-20 group-hover:opacity-30 transition-opacity">🎬</div>
                        </div>
            ...
            <div className="bg-gray-900/50 border border-gray-800 rounded-2xl p-6 mt-6 backdrop-blur-sm">
                ...
                <div className="grid grid-cols-4 gap-2 mt-4">
                    {[
                        ...
                        <div
                            key={item.range}
                            className={`text-center p-2 rounded-lg transition-all ${similarityScore >= parseFloat(item.range.split('-')[0])
